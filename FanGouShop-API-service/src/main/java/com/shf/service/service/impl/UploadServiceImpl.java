...
import com.shf.common.vo.FileResultVo;
import com.shf.common.vo.UploadCommonVo;
...
import com.shf.common.utils.UploadUtil;
import com.shf.common.model.system.SystemAttachment;
...
//        resultFile.setServerPath(destPath);
        ...
        systemAttachment.setAttSize(resultFile.getFileSize().toString());
        systemAttachment.setAttType(resultFile.getType());
        systemAttachment.setImageType(2);   //图片上传类型 1本地 2七牛云 3OSS 4COS, 默认本地，任务轮询数据库放入云服务
        systemAttachment.setPid(pid);
